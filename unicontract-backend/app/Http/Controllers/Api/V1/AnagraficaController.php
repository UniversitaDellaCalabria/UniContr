    ...
    public function show($id_ab)
    {
        ...
        $message = '';
            ...
            ->leftJoin('SIAXM_UNICAL_PROD.V_IE_RU_PERS_TITSTU', function($join) {
                ...
                $join->on('SIAXM_UNICAL_PROD.V_IE_RU_PERS_TITSTU.MATRICOLA', '=', 'SIARU_UNICAL_PROD.VD_ANAGRAFICA.MATRICOLA')
            ...
            ->first(['SIARU_UNICAL_PROD.FAM_ANAGRAFICA.RAP_PARENTELA', 'SIARU_UNICAL_PROD.FAM_ANAGRAFICA.COD_FISC AS COD_FISC_CONIUGE', 'SIAXM_UNICAL_PROD.V_IE_RU_PERS_TITSTU.DESCR AS TITOLO_STUDIO', 'SIARU_UNICAL_PROD.VD_ANAGRAFICA.*', 'SIARU_UNICAL_PROD.COMUNE_PROV.PROVINCIA']);
