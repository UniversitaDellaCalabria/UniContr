...
class AnagraficaController extends Controller
{
    ...
    public function show($id_ab)
    {
        ...
        $message = '';
            ...
            ->first(['SIARU_UNICAL_PROD.FAM_ANAGRAFICA.RAP_PARENTELA', 'SIARU_UNICAL_PROD.FAM_ANAGRAFICA.COD_FISC AS COD_FISC_CONIUGE', 'SIARU_UNICAL_PROD.V_IE_RU_PERS_TITSTU.DS_GRADO AS TITOLO_STUDIO', 'SIARU_UNICAL_PROD.VD_ANAGRAFICA.*', 'SIARU_UNICAL_PROD.COMUNE_PROV.PROVINCIA']);
