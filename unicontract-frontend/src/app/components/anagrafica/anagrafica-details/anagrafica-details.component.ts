    ...
    */
    ...
    // tutela lavoratrici madri
    {
      ...
      fieldGroup: [
        ...
        {
          template: '<span class="form-text">La documentazione e la normativa vigente sono dispobili <a href="/assets/documents/informativa_tutela_lavoratrici_madri.pdf" target="_blank">a questo URL</a></span>',
          className: 'pb-1'
        }
