  ...
  fields: FormlyFieldConfig[] = [
    ...
    //nota
    {
      ...
      fieldGroup: [
      {
        ...
        template: "<h4>Dal 01/03/2022, in seguito all'introduzione dell'Assegno Unico Universale (AUU), le detrazioni per figli a carico possono essere richieste solo per figli oltre i 21 anni di età.</h4>",
        className: 'col-auto',
        hideExpression: (model, formstate) => {
          return (!this.model.flag_richiesta_detrazioni);
        }
